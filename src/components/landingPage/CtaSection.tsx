...
const CtaSection = () => {
  return (
    ...
    <img src="3dhumanshe.png" style={{ height:"200px", width:"100px"}} className="-mt-32 absolute top-0 left-0  object-contain" />
        <div className=" lg:flex my-10 lg:items-center lg:justify-between w-full bg-white mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 rounded-lg shadow-xl">
                <span className="mt-16 block text-2xl font-extrabold capitalize">
